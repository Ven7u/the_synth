...
impl SynthTheme {
    ...
    pub fn apply_to_egui(&self, ctx: &egui::Context) {
        ...
        let lighten = |c: Color32, by: u8| Color32::from_rgb(
        ...
        let accent_fill = Color32::from_rgba_premultiplied(
            accent.r() / 5,
            accent.g() / 5,
            accent.b() / 5,
            200,
        ...
        // Selection
        vis.selection.bg_fill = Color32::from_rgba_premultiplied(
            accent.r() / 5,
            accent.g() / 5,
            accent.b() / 5,
            90,
...
pub fn midnight() -> SynthTheme {
    ...
    SynthTheme {
        ...
        rounding_sm: r_sm, rounding_md: r_md, rounding_lg: r_lg,
        stroke_ui: s_ui, stroke_focus: s_foc, stroke_active: s_act,
    }
}
