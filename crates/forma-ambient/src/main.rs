//! forma-ambient — multi-track ambient/electronic music maker.
//!
//! Thin shell over `forma-engine::generative`. Opens a cpal stream and a minimal egui window.
...
use forma_engine::arp::{ArpMode, ArpState, ClockDiv, Scale, ScaleWalker};
...
fn build_stream(
    ...
    rx: forma_control::ControlReceiver,
    sr: f64,
...
struct AmbientBoxApp {
    ...
    markov_shared_cache: Option<forma_engine::generative::MarkovEngineShared>,
    ...
    // Timeline (Phase 8.7)
    timeline: forma_engine::generative::Timeline,
    ...
    timeline_status: Option<forma_engine::generative::TimelineStatus>,
...
impl AmbientBoxApp {
    ...
    fn new(
        ...
        Self {
            ...
            timeline: forma_engine::generative::Timeline::inactive(),
...
// Keyboard note mapping (same as forma)
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    let _ = forma_ui::knob(ui, "Master", &mut self.master_vol_ui, 0.0, 1.0);
                });
            });
            ui.horizontal(|ui| {
            ...
            egui::Grid::new("track_strips")
                ...
                for ti in 0..TRACK_COUNT {
                    ui.horizontal(|ui| {
                        ...
                        let _ = forma_ui::knob(ui, "Vol", &mut self.track_vol_ui[ti], 0.0, 1.0);
                        let _ = forma_ui::knob(ui, "Cut", &mut self.track_cutoff_ui[ti], 80.0, 18000.0);
                        let _ = forma_ui::knob(ui, "Shim", &mut self.track_shimmer_send_ui[ti], 0.0, 1.0);
                    ...
                    if self.track_expanded[ti] {
                        ui.horizontal(|ui| {
                            ui.add_space(16.0);
                            let _ = forma_ui::knob(ui, "Res", &mut self.track_resonance_ui[ti], 0.1, 10.0);
                            let _ = forma_ui::knob(ui, "Crys", &mut self.track_crystal_send_ui[ti], 0.0, 1.0);
                            let _ = forma_ui::knob(ui, "LFO", &mut self.lfo_depth_ui[ti], 0.0, 1.0);
                            ui.label("LFO→");
                ...
                for i in 0..TRACK_COUNT {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.add(egui::Slider::new(&mut self.markov_voice_density_ui[i], 0.0f32..=1.0)
                            .step_by(0.01).clamping(egui::SliderClamping::Always));
                        let _ = forma_ui::knob(ui, "Vol", &mut self.track_vol_ui[i], 0.0, 1.0);
                        let _ = forma_ui::knob(ui, "Shim", &mut self.track_shimmer_send_ui[i], 0.0, 1.0);
                        let _ = forma_ui::knob(ui, "Crys", &mut self.track_crystal_send_ui[i], 0.0, 1.0);
                        ...
                        ui.add_enabled_ui(self.lfo_enabled_ui[i], |ui| {
                            ...
                            let _ = forma_ui::knob(ui, "Depth", &mut self.lfo_depth_ui[i], 0.0, 1.0);
                            // Sync toggle
                            ...
                            if self.lfo_sync_ui[i] {
                                egui::ComboBox::from_id_salt(format!("lfo_div_{i}"))
                                    .selected_text(forma_common::ClockDivision::from_u8(self.lfo_division_ui[i]).label())
                                    .width(52.0)
                                    .show_ui(ui, |ui| {
            ...
            if !markov_active {
                ...
                ui.horizontal(|ui| {
                    let _ = forma_ui::knob(ui, "Volume", &mut self.track_vol_ui[ti], 0.0, 1.0);
                    let _ = forma_ui::knob(ui, "Cutoff", &mut self.track_cutoff_ui[ti], 80.0, 18000.0);
                    let _ = forma_ui::knob(ui, "Resonance", &mut self.track_resonance_ui[ti], 0.1, 10.0);
                    let _ = forma_ui::knob(ui, "Shimmer", &mut self.track_shimmer_send_ui[ti], 0.0, 1.0);
                    let _ = forma_ui::knob(ui, "Crystal", &mut self.track_crystal_send_ui[ti], 0.0, 1.0);
                });
                ui.separator();
                // ARP + Walker
                ui.columns(2, |cols| {
            ...
            ui.horizontal(|ui| {
                ...
                if forma_ui::knob(ui, "Mix", &mut self.shimmer_mix, 0.0, 1.0) {}
                if forma_ui::knob(ui, "Shim", &mut self.shimmer_amt, 0.0, 1.0) {}
                if forma_ui::knob(ui, "Size", &mut self.shimmer_size, 0.0, 1.0) {}
                if forma_ui::knob(ui, "Damp", &mut self.shimmer_damp, 0.0, 1.0) {}
                ui.label("Pitch:");
            ...
            ui.horizontal(|ui| {
                ...
                if forma_ui::knob(ui, "Mix", &mut self.crystal_mix, 0.0, 1.0) {}
                if forma_ui::knob(ui, "Grain", &mut self.crystal_grain_ms, 10.0, 400.0) {}
                if forma_ui::knob(ui, "Scatter", &mut self.crystal_scatter, 0.0, 1.0) {}
                ...
                if self.crystal_delay_sync_ui {
                    egui::ComboBox::from_id_salt("crystal_delay_div")
                        .selected_text(forma_common::ClockDivision::from_u8(self.crystal_delay_division_ui).label())
                        .width(56.0)
                        .show_ui(ui, |ui| {
                            for div in forma_common::ClockDivision::ALL {
                    ...
                    if forma_ui::knob(ui, "Delay", &mut self.crystal_delay_ms, 20.0, 1200.0) {}
                }
                if forma_ui::knob(ui, "Feedback", &mut self.crystal_feedback, 0.0, 0.95) {}
                ui.label("Pitch:");
            ...
            ui.horizontal(|ui| {
                for i in 0..ACTIVE_MACRO_KNOBS {
                    ...
                    let _ = forma_ui::knob(ui, &label, &mut self.macro_ui_values[i], 0.0, 1.0);
                }
            });
            ui.separator();
            ...
            ui.collapsing("DRUMS", |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    let _ = forma_ui::knob(ui, "Vol", &mut self.drum_master_vol_ui, 0.0, 1.0);
                    ui.label("Pattern:");
            ...
            if let Ok(mut eng) = self.engine.try_lock() {
                ...
                if self.crystal_delay_sync_ui {
                    ...
                    let div = forma_common::ClockDivision::from_u8(self.crystal_delay_division_ui);
                    ...
                    if let Some(ms) = &scene.markov {
                        ...
                        if let Some(ref sections) = ms.timeline {
                            if !sections.is_empty() {
                                ...
                                let mut base = forma_engine::generative::ResolvedState::snapshot_from_shared(&eng.markov_shared);
                                ...
                                self.timeline = forma_engine::generative::Timeline::new(
                                    sections.clone(),
                                    ms.timeline_loop,
                                    base,
                                );
                                ...
                                self.timeline = forma_engine::generative::Timeline::inactive();
                            }
                        } else {
                            self.timeline = forma_engine::generative::Timeline::inactive();
                        }
