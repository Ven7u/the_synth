...
//!
//! Run:
//!   cargo run -p forma-bevy --example bevy_wipeout_track --features bevy --release
...
use forma_bevy::{SceneTransitionMode, SynthBackendKind, SynthBevyConfig, SynthEvent, SynthPlugin};
...
fn beat_sync_system(
    synth_params: Option<Res<forma_bevy::SynthParam>>,
