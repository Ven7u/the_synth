//! Generative music layer on top of `synth-engine`'s multi-track core.
//!
...
//! any host — `the-synth`, `ambient-box`, `synth-bevy`, a future plugin
...
//! downstream code can `use synth_engine::generative::*;` without needing
...
// consumers of `synth_engine::generative::*` don't need a separate import
