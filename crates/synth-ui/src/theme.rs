...
impl SynthTheme {
    ...
    pub fn apply_to_egui(&self, ctx: &egui::Context) {
        ...
        let round_md = CornerRadius::from(self.rounding_md);
        ...
        // Window chrome
        vis.window_corner_radius = CornerRadius::from(self.rounding_lg);
        ...
        style.spacing.window_margin = Margin::from(self.sp_md);
        style.spacing.button_padding = Vec2::new(self.sp_sm, 3.0);
        style.spacing.menu_margin = Margin::from(self.sp_sm);
